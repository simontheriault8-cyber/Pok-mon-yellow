...
export const POKEMON_YELLOW_RAM = {
  ...
  // Standard Yellow EN: wEnemyMon starts at 0xCFE4 (Red/Blue EN is 0xCFE5, Yellow FR is 0xCFE3)
  ENEMY_MON_SPECIES_EN: 0xCFE4,
  ENEMY_MON_HP_EN: 0xCFE5,
  ENEMY_MON_STATUS_EN: 0xCFE8,
  ENEMY_MON_TYPE1_EN: 0xCFE9,
  ENEMY_MON_TYPE2_EN: 0xCFEA,
  ENEMY_MON_LEVEL_EN: 0xCFF2,
  ENEMY_MON_MAX_HP_EN: 0xCFF3,
